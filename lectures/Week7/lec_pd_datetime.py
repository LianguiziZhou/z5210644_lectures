...
date = dt.datetime(year=1999, month=2, day=25)
...
x_reform = x.strftime('%A of week number %U of the year %Y')
print(f"{x.strftime('%A')} of the week number {x.strftime('%U')} of the year {x.strftime('%Y')}")
print(x_reform)
# ----------------------------------------------------------------------------
...
#ex2:
print(prc.loc[:,'Adj Close'])
adj = prc.loc[:, 'Adj Close']
print(adj.loc['2019-03'])
i = 0
for date in adj.loc['2019-03']:
   if i == 14:
      print(f"The value of \"Adj Close\" for the 15th trading day in March 2019 in the prc is {date}")
   i += 1

print(f"The value of \"Adj Close\" for the 15th trading day in March 2019 in the prc is {adj.loc['2019-03'].iloc[14]}")