        ...
        for line in f:
            for word in line.split():
                if word in dic:
                    ...
                    dic[word] = 0
                word_frep.append(dic.get(word))

    for word,value in dic.items():
        if value == max(word_frep):
            print(f"The most frequency word is {word} and the number of occurance is {value}" )


most_text('/Users/lianguizizhou/PycharmProjects/toolkit/iso.txt')
